package com.github.diinnk.powly.controllers.view

import com.github.diinnk.powly.common.Constants.{pollDBTableName, pollOptionsDBTableName, pollVotesDBTableName}
import com.github.diinnk.powly.config.ConfigManager.limitAllRowCount
import com.github.diinnk.powly.common.payloads.{GetPollPayload, PollBasics, PollOptions, VoteDetail, VoteSummary}
...
object DBOps extends PollDBHelper {
  ...
  private def getVoteSummaries(pollId: Int)(implicit h2Conn: Connection): List[VoteSummary] = {
  ...
  private def getVoteDetail(pollId: Int)(implicit h2Conn: Connection): List[VoteDetail] = {
    val rs = getH2ResultSet(
      s"""select
         |  a.optionId,
